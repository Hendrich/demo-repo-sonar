...
exports.processAndAnalyzeWeatherData = processAndAnalyzeWeatherData;
...
function getHistoricalWeather(city, fromDate) {
...
function processAndAnalyzeWeatherData(data) {
...
function generateWeatherSummary(t, h, w) {
    let s = "";
    if (t > 30) {
        s += "Very hot. ";
    }
